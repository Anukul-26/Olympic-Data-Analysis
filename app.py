...
st.sidebar.markdown(
    "![Olympic Logo](https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/Olympic_rings_without_rims.svg/800px-Olympic_rings_without_rims.svg.png)"
)
...
if user_menu == 'Medal Tally':
    ...
    st.sidebar.markdown("![Medal](https://www.pngall.com/wp-content/uploads/2016/06/Medal-Free-Download-PNG.png)")
...
if user_menu == 'Country-wise Analysis':
    ...
    st.sidebar.markdown("![Country](https://upload.wikimedia.org/wikipedia/commons/b/ba/Flag_Map_of_World_%28Olympics%29.png)")
